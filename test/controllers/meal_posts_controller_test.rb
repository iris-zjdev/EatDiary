...
class MealPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal_post" do
    assert_difference("MealPost.count") do
      post meal_posts_url, params: { meal_post: { content: @meal_post.content, meal_type: @meal_post.meal_type, source_type: @meal_post.source_type, title: @meal_post.title, user_id: @meal_post.user_id } }
    end
  ...
  test "should update meal_post" do
    patch meal_post_url(@meal_post), params: { meal_post: { content: @meal_post.content, meal_type: @meal_post.meal_type, source_type: @meal_post.source_type, title: @meal_post.title, user_id: @meal_post.user_id } }
